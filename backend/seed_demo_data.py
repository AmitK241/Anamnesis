...
# ── 3 curated detection payloads — real URNs, real field names ────────────────
INCIDENT_CONFIGS = [
    {
        "label":    "Incident 1: The Hard Way (baseline — no memory)",
        "urn":      ORDERS_URN,
        "detection": {
            ...
            "type_changes":    [],
            "break_summary":   (
                "1 field(s) were removed: order_status was dropped from the orders table "
                "after a schema migration to a new order-management platform."
            ),
        },
    },
    {
        "label":    "Incident 2: The Fast Way (recall expected — score ~0.83)",
        "urn":      CUSTOMERS_URN,
        "detection": {
    ...
    {
        "label":    "Incident 3: The Range (partial match — score ~0.67-0.69)",
        "urn":      PRODUCTS_URN,
        "detection": {
